    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.PositiveIntegerField(default=0, editable=False, verbose_name='게시글 수')),
        ...
        migrations.AddField(
            model_name='tag',
            name='parent',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tag_manager.tag'),
        ),
    ]
